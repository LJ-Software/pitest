...
public enum RelationalOperatorReplacementMutator12 implements MethodMutatorFactory {

        CONDITIONALS_REPLACEMENT_MUTATOR12;
...
class RelationalReplacementMethodVisitor12 extends AbstractJumpMutator {

        RelationalReplacementMethodVisitor12(final MethodMutatorFactory factory, final MutationContext context,
        ...
        static {
                ...
                MUTATIONS.put(Opcodes.IFEQ, new Substitution(Opcodes.IFLE,
                                "Replaced if value is 0 with if value is less than or equal to 0"));
                ...
                MUTATIONS.put(Opcodes.IFLE, new Substitution(Opcodes.IF_ICMPEQ,
                ...
                MUTATIONS.put(Opcodes.IFNULL, new Substitution(Opcodes.IFLE,
                                "Replaced if value is null with if value is less than or equal to 0"));
                MUTATIONS.put(Opcodes.IFNONNULL, new Substitution(Opcodes.IFLE,
