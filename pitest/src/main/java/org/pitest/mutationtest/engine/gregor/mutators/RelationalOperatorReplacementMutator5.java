...
public enum RelationalOperatorReplacementMutator5 implements MethodMutatorFactory {
        ...
        CONDITIONALS_REPLACEMENT_MUTATOR5;
...
class RelationalReplacementMethodVisitor5 extends AbstractJumpMutator {

        RelationalReplacementMethodVisitor5(final MethodMutatorFactory factory, final MutationContext context,
