...
public enum RelationalOperatorReplacementMutator3 implements MethodMutatorFactory {
        ...
        CONDITIONALS_REPLACEMENT_MUTATOR3;
...
class RelationalReplacementMethodVisitor3 extends AbstractJumpMutator {

        RelationalReplacementMethodVisitor3(final MethodMutatorFactory factory, final MutationContext context,
