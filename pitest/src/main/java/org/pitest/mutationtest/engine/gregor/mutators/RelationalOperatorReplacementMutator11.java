...
public enum RelationalOperatorReplacementMutator11 implements MethodMutatorFactory {

        CONDITIONALS_REPLACEMENT_MUTATOR11;
...
class RelationalReplacementMethodVisitor11 extends AbstractJumpMutator {

        RelationalReplacementMethodVisitor11(final MethodMutatorFactory factory, final MutationContext context,
        ...
        static {
                ...
                MUTATIONS.put(Opcodes.IFGE, new Substitution(Opcodes.IF_ICMPEQ,
                ...
                MUTATIONS.put(Opcodes.IFNULL, new Substitution(Opcodes.IFGE,
                                "Replaced if value is null with if value is greater than or equal to 0"));
                MUTATIONS.put(Opcodes.IFNONNULL, new Substitution(Opcodes.IFGE,
